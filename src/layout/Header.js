                ...
                <div className={(menuOpen ? "flex flex-grow items-center" : "hidden")+" lg:block"}>
                    <ul className={(menuOpen ?"flex flex-col list-none":"inline-flex")} >
                        ...
                        <li className="nav-item">
                            <a className="px-4 hover:text-gray-800" href="#" onClick={()=>appActions.setOption1()}>API</a>
                        </li>
                        <li className="nav-item">
                            <a className="px-4 hover:text-gray-800" href="#" onClick={()=>appActions.setOption2()}>Cartellera</a>
                        </li>
                        <li className="nav-item">
                            <a className="px-4 hover:text-gray-800" href="#" onClick={()=>appActions.setOption3()}>Populars</a>
                        </li>
                    </ul>
                </div>
            </div>
